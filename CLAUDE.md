# Imersão Pocket — confirmação de presença (Uélicon)
...
- Como tudo funciona, onde editar e como publicar: `README.md`

Stack: HTML + PHP 8.3 sem framework, dados em NDJSON/JSON com `flock`, sem banco.
Repositório público: senha, telefones do grupo e respostas ficam só no servidor.
